...
namespace CRM.Controllers
{
    public class EtapaController : Controller
    {
        ...
        // GET: Etapa
        public ActionResult Index(Application.CatEtapaOportunidad APcatEtapaOportunidad)
        {
            if (ValidaUsuario())
            {
                List<Models.CatEtapaOportunidad> catEtapaOportunidad = APcatEtapaOportunidad.CatEtapaOportunidad_Seleccionar();
                ViewBag.EtapaOportunidad = catEtapaOportunidad;
